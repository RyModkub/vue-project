<template>
  <div class="container">
    ...
    <h3>✅ สรุป</h3>
    <ul>
      <li>โค้ดนี้ใช้ fetch() เพื่อโหลดข้อมูลผู้ใช้จาก API และแสดงใน <strong style="color: orange;">&lt;ul&gt;</strong></li>
      <li><strong style="color: orange;">mounted()</strong> ช่วยให้ API ถูกเรียกเมื่อคอมโพเนนต์โหลดเสร็จ</li>
      <li>ใช้โค้ดน้อย อ่านง่าย แต่ไม่มีการจัดการ error (ถ้าต้องการ error handling ต้องเพิ่ม <strong style="color: orange;">try...catch</strong> )</li>
    </ul>
